<?php
  ...
  if($_SESSION['usertype']!='Customer'){
    ...
    else if (User::addFavoriteRestaurant($db,(int) User::getCustomerID($db,$_SESSION['username']),(int) $_POST['id'])){
    ...
    else if (User::addFavoriteItem($db,(int)User::getCustomerID($db,$_SESSION['username']),(int) $_POST['id'])){
